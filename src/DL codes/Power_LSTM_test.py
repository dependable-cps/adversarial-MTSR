...
df = pd.DataFrame(df_resample)

## save to xlsx file

filepath1 = '../../Output/Power_days.csv'
...
filepath1 = '../../Output/Power_LSTM_train.csv'
...
if os.path.isfile(model_path):
	...
	filepath1 = '../../Output/Power_LSTM_predicted_file.csv'
	filepath2 = '../../Output/Power_LSTM_true_file.csv'
